...
- Use `build-run-debug` when the repo is Xcode-first or when you need a stable macOS app launch script.
- Use `test-triage` when the central problem is narrowing or classifying test failures.
