...
If already on a feature branch, use it. If on `main`, `master`, or the repo default branch, create a new feature branch using the same slugging rules as `/implement`.

> **NEVER push directly to `main`, `master`, or the repo default branch. NEVER.**
